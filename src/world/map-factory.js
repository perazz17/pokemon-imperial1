...
if(kind==='route'){
 ...
 const routeShrines=[['Pietra dei Pascoli','Una pietra votiva ricorda i primi allevatori del regno.'],['Vecchia Stazione','Una targa arrugginita conserva il nome della prima linea ferroviaria.'],['Belvedere Astravia','Le stelle incise indicano la rotta usata dagli antichi archivisti.'],['Segnavento del Porto','Le incisioni seguono ancora la direzione delle correnti marine.'],['Incudine Antica','Qui venivano forgiati attrezzi per ricostruire le città dopo la guerra.'],['Campana della Memoria','La campana porta i nomi di chi non compare nei registri imperiali.'],['Pietra del Drago','La promessa incisa qui precede di secoli la Corona Imperiale.'],['Seme della Valle','Un seme conservato nella pietra ricorda il patto tra le città agricole.']][i];
 obj(r,{kind:'landmark',x:4,y:5,style:['abbey','rail','stars','lighthouse','forge','memorial','stele','greenhouse'][i],name:routeShrines[0]});
 obj(r,{kind:'relic',x:4,y:6,id:'route-relic-'+i,name:routeShrines[0],text:routeShrines[1]});
